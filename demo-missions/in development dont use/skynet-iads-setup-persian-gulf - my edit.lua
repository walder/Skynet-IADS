...
--this SA-10 site will go live at 60% of its max search range:
iranIADS:getSAMSiteByGroupName('SAM - SA-10 - Hormuz'):setEngagementZone(SkynetIADSAbstractRadarElement.GO_LIVE_WHEN_IN_SEARCH_RANGE):setGoLiveRangeInPercent(60)
